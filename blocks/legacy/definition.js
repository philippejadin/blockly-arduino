...
Blockly.Blocks["soft_init"] = {
  init: function() {
    ...
    this.appendDummyInput().appendField(Blockly.Msg.SSERIAL_Init).appendField(new Blockly.FieldDropdown(Blockly.Msg.rxtx), "PIN1").appendField("/ Tx").appendField(new Blockly.FieldDropdown(Blockly.Msg.rxtx), "PIN2");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("vitesse").appendField(new Blockly.FieldDropdown(profile.defaultBoard.serial), "SPEED");
...
Blockly.Blocks["serial_init"] = {
  init: function() {
    ...
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.setInputsInline(false);
    this.appendDummyInput().appendField(Blockly.Msg.Serial_Init).appendField(new Blockly.FieldDropdown(profile.defaultBoard.serialPin), "pin");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField("vitesse").appendField(new Blockly.FieldDropdown(profile.defaultBoard.serial), "SPEED");
...
Blockly.Blocks["serial_read"] = {
  init: function() {
    this.setColour("#006000");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.Serial_read);
    this.setInputsInline(true);
    this.setOutput(true, "Number");
...
Blockly.Blocks["lcd_aff_symbole"] = {
  init: function() {
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
...
Blockly.Blocks["inout_digital_write_validator"] = {
  init: function() {
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT1).appendField(new Blockly.FieldTextInput("", Blockly.Arduino.pinDigitalValidator), "PIN");
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_DIGITAL_WRITE_INPUT2).appendField(new Blockly.FieldDropdown(Blockly.Msg.FIELDDROPDOWN), "STAT");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["inout_digital_read_validator"] = {
  init: function() {
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_INPUT).appendField(new Blockly.FieldTextInput("", Blockly.Arduino.pinDigitalValidator), "PIN");
    this.setInputsInline(true);
    this.setOutput(true, "Boolean");
    this.setTooltip(Blockly.Msg.ARDUINO_INOUT_DIGITAL_READ_TOOLTIP)
  }
...
Blockly.Blocks["inout_analog_write"] = {
  init: function() {
    this.setColour("#787746");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownPWM), "broche");
...
Blockly.Blocks["inout_analog_write_validator"] = {
  init: function() {
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT1).appendField(new Blockly.FieldTextInput("", Blockly.Arduino.pinAnalogValidator), "PIN");
    this.appendValueInput("NUM", "Number").appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_INPUT2).setCheck("Number");
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(Blockly.Msg.ARDUINO_INOUT_ANALOG_WRITE_TOOLTIP)
...
Blockly.Blocks["inout_analog_read"] = {
  init: function() {
    this.setColour("#787746");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_INPUT).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setOutput(true, "Number");
...
Blockly.Blocks["inout_analog_read_validator"] = {
  init: function() {
    this.setColour("#00929F");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_INPUT).appendField(new Blockly.FieldTextInput("", Blockly.Arduino.pinAnalogValidator), "PIN");
    this.setOutput(true, "Number");
    this.setTooltip(Blockly.Msg.ARDUINO_INOUT_ANALOG_READ_TOOLTIP)
  }
};
Blockly.Blocks["inout_attachInterrupt"] = {
  init: function() {
    ...
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.LKL_MODE).appendField(new Blockly.FieldDropdown(profile.defaultBoard.interrupt), 'PIN');
...
Blockly.Blocks["inout_detachInterrupt"] = {
  init: function() {
    this.setColour("#787746");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.LKL_DETACHINTERRUPT_PIN).appendField(new Blockly.FieldDropdown(profile.defaultBoard.interrupt), 'PIN');
...
Blockly.Blocks['base_code_entree'] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldTextInput("code arduino "), "TEXT");
    this.setOutput(true);
    this.setColour("#4a235a");
...
Blockly.Blocks["millis"] = {
  init: function() {
    this.setColour("#aab7b8");
    this.setHelpUrl(Blockly.Msg.HELPURL);
    this.appendDummyInput().appendField(Blockly.Msg.millis1).appendField(new Blockly.FieldDropdown(Blockly.Msg.time), "unite").appendField(Blockly.Msg.millis2);
    this.setOutput(true, "Number");
    this.setTooltip(Blockly.Msg.ARDUINO_SINCE_PROGRAM_STARTED_TOOLTIP)
  }
};
Blockly.Blocks['tempo_sans_delay'] = {
  init: function() {
    this.appendValueInput("DELAY_TIME", "Number").setCheck("Number").appendField(Blockly.Msg.tempo1);
    this.appendDummyInput().appendField(new Blockly.FieldDropdown(Blockly.Msg.time), "unite").appendField(Blockly.Msg.tempo2);
...
Blockly.Blocks["bargraphe_allume"] = {
  init: function() {
...
Blockly.Blocks["lp2i_mp3_volume"] = {
  init: function() {
    this.appendValueInput("Volume", "Number").setAlign(Blockly.ALIGN_RIGHT).appendField(new Blockly.FieldImage("data:image/png;base64,", 18, 20, "+/-")).appendField(Blockly.Msg.lp2i_mp3_vol);
    this.setInputsInline(false);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#00929F");
...
Blockly.Blocks["moteur_dc"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 75, 50))
      .appendField(Blockly.Msg.moteur).appendField(new Blockly.FieldDropdown([
        [Blockly.Msg.right, "6"],
        [Blockly.Msg.left, "5"]
      ]), "MOTEUR");
...
Blockly.Blocks["moteur_dc_stop"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 75, 50))
      .appendField(Blockly.Msg.moteurstop).appendField(new Blockly.FieldDropdown([
        [Blockly.Msg.right, "6"],
        [Blockly.Msg.left, "5"]
      ]), "MOTEUR");
    this.setPreviousStatement(true, null);
...
Blockly.Blocks["moteur_action"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/jpeg;base64,", 60, 60))
      .appendField(new Blockly.FieldDropdown(Blockly.Msg.sens), "menu").appendField(Blockly.Msg.vitesse).appendField(new Blockly.FieldTextInput("", Blockly.FieldTextInput.numberValidator), "speed");
    this.setInputsInline(false);
    this.setColour("#00929f");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["moteur3v"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 45, 45))
      .appendField(Blockly.Msg.moteur + Blockly.Msg.pin).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownPWM), "pin");
...
Blockly.Blocks["matrice8x8_efface"] = {
  init: function() {
...
Blockly.Blocks["binaire"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldDropdown(Blockly.Msg.FIELDDROPDOWN_ONOFF_matrice), "bin");
    this.setColour("#00929F");
    this.setOutput(true, "Boolean");
    this.setHelpUrl(Blockly.Msg.matrice8x8_helpurl);
    this.setTooltip(Blockly.Msg.matrice8x8_binaire_tooltip)
  }
};
Blockly.Blocks["bluetooth_a"] = {
  init: function() {
    this.appendValueInput("data_s").setCheck("Number").appendField(new Blockly.FieldImage("data:image/png;base64,", 32, 32, "B"))
      .appendField(Blockly.Msg.bluetooth2);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#006000");
...
Blockly.Blocks["bluetooth_b"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 32, 32, "B"))
      .appendField(Blockly.Msg.bluetooth1);
...
Blockly.Blocks["light_sensor"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 40, 40))
      .appendField(Blockly.Msg.light).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setColour("#00929F");
...
Blockly.Blocks["potentiometre"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 37, 50))
      .appendField(Blockly.Msg.potar).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setColour("#00929F");
...
Blockly.Blocks["lm35"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 32, 50))
      .appendField(Blockly.Msg.lm35).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setColour("#00929F");
...
Blockly.Blocks['block_anticollision'] = {
  init: function() {
...
Blockly.Blocks["ultrason_distance"] = {
  init: function() {
...
Blockly.Blocks["esp8266_init"] = {
  init: function() {
    ...
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 31, 23))
      .appendField(Blockly.Msg.esp8266_1);
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.esp8266_2).appendField(new Blockly.FieldTextInput("monWIFI"), "SSID");
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.esp8266_3).appendField(new Blockly.FieldTextInput("123456789"), "KEY");
    this.setPreviousStatement(false);
    this.setNextStatement(false);
    this.setTooltip(Blockly.Msg.TOOLTIP_esp8266)
  }
};
Blockly.Blocks["esp8266_send"] = {
  init: function() {
    this.setColour("#006000");
    this.setHelpUrl(Blockly.Msg.esp8266_url);
    this.appendValueInput("message").appendField(new Blockly.FieldImage("data:image/png;base64,", 31, 23))
      .appendField("envoyer");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.TOOLTIP_esp8266)
...
Blockly.Blocks["esp8266_receive"] = {
  init: function() {
    this.setColour("#006000");
    this.setHelpUrl(Blockly.Msg.esp8266_url);
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 33, 33))
      .appendField(Blockly.Msg.bluetooth1);
    this.appendValueInput("CASE0").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.CONTROLS_SWITCH_MSG_CASEBREAK);
    this.appendStatementInput("DO0").setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.CONTROLS_IF_MSG_THEN);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.esp8266_tooltip);
    this.setMutator(new Blockly.Mutator(["bluetooth_create_item", "bluetooth_default"]));
    this.casebreakCount_ = 0;
    this.defaultCount_ = 0
  },
...
Blockly.Blocks["cap615"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 21, 60))
      .appendField(Blockly.Msg.hum).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setColour("#00929F");
    this.setHelpUrl("https://www.carnetdumaker.net/articles/la-conversion-analogique-numerique-avec-arduino-genuino/");
    this.setOutput(true, "Number");
...
Blockly.Blocks["cap661"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 45, 45))
      .appendField("impulsions sur la broche").appendField(new Blockly.FieldDropdown(profile.defaultBoard.interrupt), "broche");
    this.setColour("#00929F");
...
Blockly.Blocks["m_pap"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 62, 45))
      .appendField("Moteur pas à pas");
    this.appendValueInput("pas", "Number").setAlign(Blockly.ALIGN_RIGHT).appendField("pas");
    this.appendValueInput("vit", "Number").setAlign(Blockly.ALIGN_RIGHT).appendField("vitesse");
...
Blockly.Blocks["m_pap_step"] = {
  init: function() {
    this.appendValueInput("step", "Number").appendField("avancer de");
...
Blockly.Blocks["grove_ldr"] = {
  init: function() {
    this.appendDummyInput().appendField(new Blockly.FieldImage("data:image/png;base64,", 41, 45))
      .appendField(Blockly.Msg.grove_ldr).appendField(new Blockly.FieldDropdown(profile.defaultBoard.dropdownAnalog), "broche");
    this.setColour("#00929F");
